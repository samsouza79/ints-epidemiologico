              ...
              examRanking.map((exam, idx) => (
                <div key={idx} className="group flex flex-col gap-1.5">
                  <div className="flex justify-between items-end">
                    <span className="text-[11px] font-bold text-slate-700 truncate max-w-[85%] uppercase tracking-tight">
                      {idx + 1}. {exam.name} — <span className="font-black text-blue-600">{exam.total.toLocaleString()}</span>
                    </span>
                  </div>
